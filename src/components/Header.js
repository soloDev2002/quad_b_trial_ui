...
function Header({ darkTheme, handleToggleTheme }) {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setProgress((progress) => (progress >= 1 ? progress - 1 : 60));
      setPrevProgress((progress / 60) * 100);
    }, 1000);
    ...
    <div className="Header">
      <div className="header__left">
        <div className="header__left__container">
          ...
          <p className="header__title__footer">
      ...
      <div className="header__middle">
        <div className="header__middle__container">
          <button
            className={`${!darkTheme && "lightTheme"} ${clicked1 && "clicked"}`}
          ...
          <button
            className={`${!darkTheme && "lightTheme"} ${clicked2 && "clicked"}`}
            style={{ display: "flex", alignItems: "center" }}
            onClick={() => {
              setClicked1(false);
          ...
          <button
            className={`${!darkTheme && "lightTheme"} ${clicked3 && "clicked"}`}
            style={{ display: "flex", alignItems: "center" }}
            onClick={() => {
              setClicked1(false);
              setClicked2(false);
      ...
      <div className="header__right">
        <div className="header__right__container">
          <div className="header__right__timer">
          ...
          <Button className="button__header__right__button" variant="contained">
            <img
            ...
            />
            <div className="button__text"> Connect Telegram</div>
          </Button>
          <Switch
